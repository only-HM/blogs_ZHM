...
export default {
  ...
  computed: {
    ...
    imagePosition() {
      ...
      const extraHegiht = this.innerSize.height - this.containerSize.height; //多出的高度
      const left = (-extraWidth / this.containerSize.width) * this.mouseX;
      const top = (-extraHegiht / this.containerSize.height) * this.mouseY;
      return {
  ...
  methods: {
    ...
    showWords() {
      ...
      this.$refs.desc.style.transition = "2s 2s";
